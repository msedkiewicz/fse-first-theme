...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<!-- wp:pattern {"slug":"second-test-theme/hidden-post-meta"} /-->
	...
	<!-- /wp:post-template -->
	<!-- wp:query-no-results -->
	<!-- wp:paragraph --><p><?php esc_html_e( 'No results found.', 'second-test-theme'); ?></p><!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
